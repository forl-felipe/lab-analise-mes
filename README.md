...
5. Confira: rodapé com `· v17` e o logo da Samarco na barra lateral.
...
| `docs/14-metas-e-origem-dos-numeros.md` | metas, limites (BD_Limites), regra do mapa de aferições e a fonte de cada número |
